...
dependencies {
  constraints {
    ...
    api("ai.runapi:runapi-grok-imagine:0.1.7")
    ...
    api("ai.runapi:runapi-kling:0.2.0")
    api("ai.runapi:runapi-luma:0.1.1")
    api("ai.runapi:runapi-midjourney:0.3.1")
    ...
    api("ai.runapi:runapi-seedream:0.2.0")
    api("ai.runapi:runapi-suno:0.3.1")
    api("ai.runapi:runapi-topaz:0.1.2")
